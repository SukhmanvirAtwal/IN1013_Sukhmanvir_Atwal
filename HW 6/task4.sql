...
WHERE b.bill_total > 450.00 AND h.first_name = 'Charles';

-- 2
-- A customer called Nerida has complained that a waiter was rude to her when she dined at the restaurant on the 11th January 2016. 
...
-- 5
-- Which customers had the largest single bill? List the customer name, the name and surname of the waiter who served them.

SELECT b.cust_name, w.first_name AS waiter_first_name, w.surname AS waiter_surname
FROM restBill b
JOIN restStaff w ON b.waiter_no = w.staff_no
